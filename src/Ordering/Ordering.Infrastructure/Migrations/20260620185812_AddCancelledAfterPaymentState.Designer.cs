...
namespace Ordering_Infrastructure.Migrations
{
    ...
    [Migration("20260620185812_AddCancelledAfterPaymentState")]
    partial class AddCancelledAfterPaymentState
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ordering_Domain.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasIndex(new[] { "Date" }, "IX_Order_Date");

                    b.HasIndex(new[] { "UserId", "State" }, "IX_Order_UserId_State");
