...
namespace Basketing.Infrastructure.Data.DbContext // مسیر دقیق DbContext خودتان
{
    public class BasketDbContextFactory : IDesignTimeDbContextFactory<BasketDbContext>
    {
        ...
        {
            // پیدا کردن خودکار مسیر پروژه Basketing.Api
            ...
            optionsBuilder.UseNpgsql(connectionString, 
                npgsqlOptions => npgsqlOptions.MigrationsAssembly("Basketing.Infrastructure"));
